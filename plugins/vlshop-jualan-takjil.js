...
`.trim()
        ...
        var dimas3 = `
 Gorengan Kamu Diborong Oleh Seseorang......
`.trim()
...
`.trim()
        ...
        var hsl = `
   *—[ Hasil Jualan Gorengan ]—*
➕ 🗣️ Nama =  ${name}
➕ 💹 Hasil Uang = [ ${randomaku1} ]
➕ ✨ Bonus Exp = [ ${randomaku2} 
➕ 📥 Gorengan Terjual = ${order}
`.trim()
        ...
        setTimeout(() => {
            m.reply('🍱🍡🍩🍦🍧🍝 \nKamu Mulai Menyiapkan Gorengan.....')
        }, 0)
        user.lastmisi = new Date * 1
    } else m.reply(`Silahkan Menunggu Selama ${timers}, Untuk *jualan gorengan* Kembali`)
}
handler.help = ['jualan']
handler.tags = ['rpgmenu','menuprem']
