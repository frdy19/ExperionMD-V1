...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {
    ...
    //Manage panel
    const domain = "https://vlshop.zanofc.biz.id" // Domain
const apikey = "ptla_M81T5usUgbaWkGmkLWavS8U5Rhr7gaJsl2QszvnvZJo" // Apikey
const c_apikey = "ptlc_8JlyUgNF2o2QhjXrkq4u05kK5uxt61sCDmzygw5MsZn" // c Apikey

    const webPage = "https://vlshop.zanofc.biz.id" // Web Page
